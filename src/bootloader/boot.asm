...
;
; FAT12 header (FAT=file allocation table)
;
jmp short start
nop
...
ebr_volume_label:			db 'LEONOS OS  '		;11 bytes padded with spaces
ebr_system_id:				db 'FAT12   '			;8 bytes, FAT12 passed with spaces
...
lba_to_chs:
	...
	xor dx, dx							; dx=0
	div word [bdb_secters_per_track]	; ax=LBA/sectors_per_track
